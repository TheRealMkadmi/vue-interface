...
<script>
import BaseType from './Types/BaseType.vue';
import unit from '../../Helpers/Functions/unit.js';
import ActivityIndicatorDots from './Types/Dots.vue';
import ActivityIndicatorSpinner from './Types/Spinner.vue';
